...
#'
#' ggplot(data = mydata) + hockey_field_top_half("#ffffff", "#ffffff", "#A9A9A9", "#A9A9A9", .5, .75, 1) + geom_point(aes(x = x, y = y))

hockey_field_top_half <- function(background_color, turf_color, line_color, goal_color, line_width, p_spot_size, turf_opacity){
